...
client.once("ready", () => {
  ...
  console.log(`PROJECT BY PHOENIX TEAM`);
  console.log(`discord.gg/XVJ6VnD9nM`);
});
  ...
  if (message.content === '!rules') {
    if (message.member.permissions.has("ADMINISTRATOR")) {
      ...
      const embed = new MessageEmbed()
        .setColor('#f8ca3d')
        .setThumbnail('https://cdn.discordapp.com/attachments/1212054605094060064/1215065379534012447/Picsart_24-03-04_12-21-14-401.jpg?ex=65fb64d1&is=65e8efd1&hm=d2ac31b2906e38ee10270a2419b666db51630768a1343a6586d2db2c59f9d994&')
        .setTitle('قوانين السيرفر')
        .setDescription('**الرجاء اختيار احد القوانين لقرائته من قائمة الاختيارات تحت**')
        .setImage('https://cdn.discordapp.com/attachments/1212054605094060064/1215065410974646282/Picsart_24-03-04_12-14-47-434.jpg?ex=65fb64d8&is=65e8efd8&hm=2d85fc0daf7a39b245df67552f404e849938b90bd809459227898174da29036f&')
